...
{
    public function attr($key, $expression)
    {
    ...
    public function ngClass($expression)
    {
        ...
        return $this->attr('ngClass', $expression);
    }
    ...
    public function ngStyle($expression)
    {
        ...
        return $this->attr('ngStyle', $expression);
    }

    public function ngRouterLink($expression)
    {
        return $this->attr('routerLink', $expression);
    }

    public function ngLink($link)
    {
        return $this->attr('routerLink', "['{$link}']");
    }

    public function ngSwitch($expression)
    {
        return $this->attr('ngSwitch', $expression);
    }
